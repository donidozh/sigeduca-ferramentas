...
Consulte também as [novidades e orientações do Arquivo Digital 0.15.0](ged/arquivo-digital.md): cadastro em caixas, seleção obrigatória antes do envio, duplicação de páginas, lista única e identificação local de documentos.
